...
const Card = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 p-4 sm:p-6 md:p-10 md:ml-10 lg:ml-0 lg:px-16">

  <div className="h-14 w-full border border-gray-300 rounded-2xl flex items-center gap-3 px-4 sm:px-5">
